...
public abstract class EntityAdvWarriorContainer extends EntityTameable implements IInventory
{
    private ItemStack[] minecartContainerItems = new ItemStack[36];
    private boolean field_94112_b = true;
    ModJam modjam = new ModJam().instance;

    public EntityAdvWarriorContainer(World par1World)
    {
        super(par1World);
    }

    public EntityAdvWarriorContainer(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
    }
    ...
    {
        if(MinecraftForge.EVENT_BUS.post(new EntityInteractEvent(par1EntityPlayer, this))) 
        {
            return true;
        }
        if (!this.worldObj.isRemote && !par1EntityPlayer.isSneaking())
        {
            par1EntityPlayer.openGui(modjam, this.entityId, this.worldObj, 0, 0, 0);
        }
