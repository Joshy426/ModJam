...
public abstract class EntityLooterContainer extends EntityTameable implements IInventory
{
    private ItemStack[] minecartContainerItems = new ItemStack[36];
    private boolean field_94112_b = true;

    public EntityLooterContainer(World par1World)
    {
        super(par1World);
    }

    public EntityLooterContainer(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
    }
