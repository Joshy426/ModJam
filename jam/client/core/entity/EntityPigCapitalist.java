...
public class EntityPigCapitalist extends EntityTameable
{
    ...
    public EntityPigCapitalist(World par1World)
    {
        super(par1World);
     ...
     */
    public EntityPigCapitalist spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        EntityPigCapitalist entitywolf = new EntityPigCapitalist(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof EntityPigCapitalist))
        {
            return false;
        }
        else
        {
            EntityPigCapitalist entitywolf = (EntityPigCapitalist)par1EntityAnimal;
