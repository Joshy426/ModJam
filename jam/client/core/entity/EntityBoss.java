...
public class EntityBoss extends EntityFlying implements IMob
{
    ...
    {
        super(par1World);
        this.texture = "/mods/modjam/textures/mobs/bosssci.png";
    ...
    protected void updateEntityActionState()
    {
        ...
        if (this.targetedEntity != null && this.targetedEntity.getDistanceSqToEntity(this) < d4 * d4)
        {
            ...
            else if (this.attackCounter > 0)
            {
                --this.attackCounter;
                //this.worldObj.playAuxSFXAtEntity((EntityPlayer)null, 1008, (int)this.posX, (int)this.posY, (int)this.posZ, 0);
                EntitySmallFireball entitylargefireball = new EntitySmallFireball(this.worldObj, this, d5, d6, d7);
                double d8 = 4.0D;
                Vec3 vec3 = this.getLook(1.0F);
                entitylargefireball.posX = this.posX + vec3.xCoord * d8;
                entitylargefireball.posY = this.posY + (double)(this.height / 2.0F) + 0.5D;
