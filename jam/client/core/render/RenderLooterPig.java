...
public class RenderLooterPig extends RenderLiving {
	 
	public RenderLooterPig(ModelBase par1ModelBase, ModelBase par2ModelBase, float par3)
    {
    ...
    {
        this.renderLivingPig((EntityPigCapitalist)par1Entity, par2, par4, par6, par8, par9);
    }
}
